...
export const ZONE1_MOBS: Record<string, MobTemplate> = {
  ...
  // Priston Tale imports — temporary placement near Sableweb Lurker spawns
  pt_hopy: {
    id: 'pt_hopy',
    name: 'Hopy',
    minLevel: 2,
...
export const ZONE1_CAMPS: CampDef[] = [
  ...
  // Priston Tale imports — temporary placement near the Sableweb Lurker spawns
  { mobId: 'pt_hopy', center: { x: -95, z: -10 }, radius: 20, count: 4, offStream: true },
  { mobId: 'pt_bargon', center: { x: -100, z: 25 }, radius: 15, count: 2, offStream: true },
