...
export const zh_CN: EnTranslations = {
  ...
  "loading": {
    ...
    "ptEntering": "You are entering",
    "enteringField": "Entering {field}...",
    "ptFieldFailed": "Could not load {field}. The field may still be preparing.",
  ...
  "classDetails": {
    ...
    "lore": {
      ...
      "tempskron_fighter": "Fighters are excellent in proximity battles and use weapons designed for short-range battle.",
      "tempskron_mechanician": "Mechanicians have the ability to handle various machines and are the only characters who can deal with offensive machinery.",
      "tempskron_pikeman": "Pikemen are good at handling spears which cause fatal injury to enemies. They have wide vision and can be equipped with durable scale mail.",
      "tempskron_archer": "Archers excel in long-range and anti-air combat. Their main weapons are bows and crossbows.",
      "morion_knight": "Knights are noble warriors with stout bodies and disciplined minds. Their attacking power comes from their religious devotion, representing great power.",
      "morion_atalanta": "Atalantas can attack enemies by using their magical power with spears or javelins. Their power is truly seen when attacking with javelin throws in long-range battle. Their unique javelin attack is the source of Atalantas' power.",
      "morion_priestess": "Priestesses are ministers who use religious magic. Through their enduring training, they have the power to heal others and attack with magical moves. They seem spiritually strong but physically weak.",
