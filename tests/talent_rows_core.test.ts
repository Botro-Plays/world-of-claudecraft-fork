...
describe('canonical Talents V2 row registry', () => {
  it('has exactly one six-row tree for each of the twenty playable classes', () => {
  ...
  it('keeps the evolved non-Warrior spec identities and only the winning Warrior masteries', () => {
    ...
    expect(ALL_CLASSES.flatMap((cls) => TALENTS[cls].specs)).toHaveLength(60);
